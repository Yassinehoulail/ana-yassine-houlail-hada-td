...
$employes = [
    ...
    ["nom" => "houlail", "poste" => "Designer", "salaire" => 4500],
    ["nom" => "Youssef", "poste" => "Analyste", "salaire" => 4200],
    ["nom" => "rim", "poste" => "Manager", "salaire" => 6200],
...
<body>
    ...
    $employes = [
        ["nom" => "yassine", "poste" => "Développeur", "salaire" => 4500],
        ["nom" => "houlail", "poste" => "Designer", "salaire" => 4000],
        ["nom" => "Yuyu", "poste" => "Analyste", "salaire" => 4800],
        ["nom" => "rim", "poste" => "Manager", "salaire" => 6000],
        ["nom" => "Omar", "poste" => "Technicien", "salaire" => 3500]
    ];
...
<body>
    ...
    $utilisateurs = [
        ["email" => "yassine@example.com", "password" => "12345"],
        ["email" => "fatima@example.com", "password" => "motdepasse"],
        ["email" => "youssef@example.com", "password" => "azerty"],
        ["email" => "rim@example.com", "password" => "password123"],
        ["email" => "mariya@example.com", "password" => "qwerty"]
    ];
